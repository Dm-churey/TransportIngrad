...
//
//public class ApplicationAdapterNew extends ListAdapter<Application, ApplicationAdapterNew.Holder> {
...
//    public ApplicationAdapterNew(Context context) {
...
//    @NonNull
//    @Override
//    public ApplicationAdapterNew.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.application_item, parent, false);
//        return new ApplicationAdapterNew.Holder(view);
//    }
//
//
//    @Override
//    public void onBindViewHolder(@NonNull ApplicationAdapterNew.Holder holder, int position) {

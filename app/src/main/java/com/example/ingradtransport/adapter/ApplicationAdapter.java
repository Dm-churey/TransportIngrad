...
//    public void filterApplications(List<Application> applications, String filter) { // Полное обновление списка при фильтрации по выбранной опции
...
//                break;
//            case "Сегодня":
//                filterApplicationsByDate(applications, LocalDate.now(), filteredApplications);
//                break;
//            case "Завтра":
//                filterApplicationsByDate(applications, LocalDate.now().plusDays(1), filteredApplications);
//                break;
//            case "Неделя":
//                filterApplicationsByDateRange(applications, LocalDate.now(), LocalDate.now().plusWeeks(1), filteredApplications);
//                break;
//            case "Месяц":
//                filterApplicationsByDateRange(applications, LocalDate.now(), LocalDate.now().plusMonths(1), filteredApplications);
//                break;
//            default:
...
//    }
//
//    private void filterApplicationsByDate(List<Application> applications, LocalDate date, List<Application> filteredApplications) {
...
//    }
//
//    private void filterApplicationsByDateRange(List<Application> applications, LocalDate startDate, LocalDate endDate, List<Application> filteredApplications) {
//        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy");
//        for (Application application : applications) {
//            LocalDate appDate = LocalDate.parse(application.getDate(), formatter);
